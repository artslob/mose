...
urlpatterns = [
    ...
    path(
        "wish/list/active/",
        views.wish.ListWishActive.as_view(),
        name="list-wish-active",
    ),
    path(
        "wish/list/closed/",
        views.wish.ListWishClosed.as_view(),
        name="list-wish-closed",
    ),
    ...
    path(
        "wish/<int:pk>/handle/<str:action>",
        views.wish.HandleWishAction.as_view(),
        name="handle-wish-action",
    ),
    path(
        "artifact/<int:pk>/delete/",
        views.artifact.DeleteArtifact.as_view(),
